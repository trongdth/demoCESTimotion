...
${OBJECTDIR}/user/main.o: user/main.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Itests -Iuser/inc `pkg-config --cflags libzmq` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/main.o user/main.cpp

${OBJECTDIR}/user/src/DeskComm.o: user/src/DeskComm.cpp
	${MKDIR} -p ${OBJECTDIR}/user/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Itests -Iuser/inc `pkg-config --cflags libzmq` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/src/DeskComm.o user/src/DeskComm.cpp

${OBJECTDIR}/user/src/DeskManager.o: user/src/DeskManager.cpp
	${MKDIR} -p ${OBJECTDIR}/user/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Itests -Iuser/inc `pkg-config --cflags libzmq` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/src/DeskManager.o user/src/DeskManager.cpp

${OBJECTDIR}/user/src/MySerial.o: user/src/MySerial.cpp
	${MKDIR} -p ${OBJECTDIR}/user/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Itests -Iuser/inc `pkg-config --cflags libzmq` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/src/MySerial.o user/src/MySerial.cpp

${OBJECTDIR}/user/src/MyZMQ.o: user/src/MyZMQ.cpp
	${MKDIR} -p ${OBJECTDIR}/user/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Itests -Iuser/inc `pkg-config --cflags libzmq` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/src/MyZMQ.o user/src/MyZMQ.cpp

${OBJECTDIR}/user/src/Thread.o: user/src/Thread.cpp
	${MKDIR} -p ${OBJECTDIR}/user/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Itests -Iuser/inc `pkg-config --cflags libzmq` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/src/Thread.o user/src/Thread.cpp
...
${TESTDIR}/tests/MySerial_testclass.o: tests/MySerial_testclass.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Itests -Iuser/inc -I. `pkg-config --cflags libzmq` -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MySerial_testclass.o tests/MySerial_testclass.cpp


${TESTDIR}/tests/MySerial_testrunner.o: tests/MySerial_testrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Itests -Iuser/inc -I. `pkg-config --cflags libzmq` -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MySerial_testrunner.o tests/MySerial_testrunner.cpp


${TESTDIR}/tests/MyZmq_testclass.o: tests/MyZmq_testclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Itests -Iuser/inc -I. `pkg-config --cflags libzmq` -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MyZmq_testclass.o tests/MyZmq_testclass.cpp


${TESTDIR}/tests/MyZmq_testrunner.o: tests/MyZmq_testrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Itests -Iuser/inc -I. `pkg-config --cflags libzmq` -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MyZmq_testrunner.o tests/MyZmq_testrunner.cpp
...
${OBJECTDIR}/user/main_nomain.o: ${OBJECTDIR}/user/main.o user/main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Itests -Iuser/inc `pkg-config --cflags libzmq` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/main_nomain.o user/main.cpp;\
	else  \
...
${OBJECTDIR}/user/src/DeskComm_nomain.o: ${OBJECTDIR}/user/src/DeskComm.o user/src/DeskComm.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Itests -Iuser/inc `pkg-config --cflags libzmq` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/src/DeskComm_nomain.o user/src/DeskComm.cpp;\
	else  \
...
${OBJECTDIR}/user/src/DeskManager_nomain.o: ${OBJECTDIR}/user/src/DeskManager.o user/src/DeskManager.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Itests -Iuser/inc `pkg-config --cflags libzmq` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/src/DeskManager_nomain.o user/src/DeskManager.cpp;\
	else  \
...
${OBJECTDIR}/user/src/MySerial_nomain.o: ${OBJECTDIR}/user/src/MySerial.o user/src/MySerial.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Itests -Iuser/inc `pkg-config --cflags libzmq` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/src/MySerial_nomain.o user/src/MySerial.cpp;\
	else  \
...
${OBJECTDIR}/user/src/MyZMQ_nomain.o: ${OBJECTDIR}/user/src/MyZMQ.o user/src/MyZMQ.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Itests -Iuser/inc `pkg-config --cflags libzmq` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/src/MyZMQ_nomain.o user/src/MyZMQ.cpp;\
	else  \
...
${OBJECTDIR}/user/src/Thread_nomain.o: ${OBJECTDIR}/user/src/Thread.o user/src/Thread.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Itests -Iuser/inc `pkg-config --cflags libzmq` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/user/src/Thread_nomain.o user/src/Thread.cpp;\
	else  \
