...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/MySerial_testclass.o ${TESTDIR}/tests/MySerial_testrunner.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	g++ -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}   `pkg-config --libs cpputest`   `cppunit-config --libs`   
...
${TESTDIR}/tests/MySerial_testclass.o: tests/MySerial_testclass.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iuser/inc -Itests `pkg-config --cflags libzmq` -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MySerial_testclass.o tests/MySerial_testclass.cpp


${TESTDIR}/tests/MySerial_testrunner.o: tests/MySerial_testrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iuser/inc -Itests `pkg-config --cflags libzmq` -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MySerial_testrunner.o tests/MySerial_testrunner.cpp


${TESTDIR}/tests/MyZmq_testclass.o: tests/MyZmq_testclass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iuser/inc -Itests `pkg-config --cflags libzmq` -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MyZmq_testclass.o tests/MyZmq_testclass.cpp


${TESTDIR}/tests/MyZmq_testrunner.o: tests/MyZmq_testrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iuser/inc -Itests `pkg-config --cflags libzmq` -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MyZmq_testrunner.o tests/MyZmq_testrunner.cpp
